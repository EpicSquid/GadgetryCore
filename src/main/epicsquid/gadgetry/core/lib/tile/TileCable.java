...
public class TileCable extends TileModular {
  ...
  public void updateConnections(IBlockState state) {
    config.setIO(EnumFacing.NORTH, canConnect(EnumFacing.NORTH) ? FaceIO.IN : FaceIO.NEUTRAL);
    config.setIO(EnumFacing.SOUTH, canConnect(EnumFacing.SOUTH) ? FaceIO.IN : FaceIO.NEUTRAL);
    config.setIO(EnumFacing.EAST, canConnect(EnumFacing.EAST) ? FaceIO.IN : FaceIO.NEUTRAL);
    config.setIO(EnumFacing.WEST, canConnect(EnumFacing.WEST) ? FaceIO.IN : FaceIO.NEUTRAL);
    config.setIO(EnumFacing.UP, canConnect(EnumFacing.UP) ? FaceIO.IN : FaceIO.NEUTRAL);
    config.setIO(EnumFacing.DOWN, canConnect(EnumFacing.DOWN) ? FaceIO.IN : FaceIO.NEUTRAL);
