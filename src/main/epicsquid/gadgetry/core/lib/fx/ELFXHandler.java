      ...
      public Void apply(NBTTagCompound t) {
        for (int i = 0; i < t.getInteger("count"); i++) {
          ...
          ClientProxy.particleRenderer
              .spawnParticle(Minecraft.getMinecraft().world, ELRegistry.PARTICLE_SMOKE, t.getDouble("x"), t.getDouble("y"), t.getDouble("z"), vx * 0.25f,
          ...
          if (Util.rand.nextInt(4) == 0) {
            ClientProxy.particleRenderer
                .spawnParticle(Minecraft.getMinecraft().world, ELRegistry.PARTICLE_SPARK, t.getDouble("x"), t.getDouble("y"), t.getDouble("z"), vx,
