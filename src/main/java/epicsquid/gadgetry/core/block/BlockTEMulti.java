...
public abstract class BlockTEMulti extends BlockTEBase implements IMultiblock {

  public BlockTEMulti(Material mat, SoundType type, float hardness, String name, Class<? extends TileEntity> teClass) {
