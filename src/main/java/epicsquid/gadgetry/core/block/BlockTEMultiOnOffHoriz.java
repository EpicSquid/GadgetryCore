...
public abstract class BlockTEMultiOnOffHoriz extends BlockTEOnOffHoriz implements IMultiblock {

  public BlockTEMultiOnOffHoriz(Material mat, SoundType type, float hardness, String name, Class<? extends TileEntity> teClass) {
