...
public class GuiModular extends GuiContainer {
  public static ResourceLocation baseTexture = new ResourceLocation("gadgetrycore:textures/gui/container.png");
  public ResourceLocation texture = new ResourceLocation("gadgetrycore:textures/gui/container.png");
