...
import epicsquid.gadgetry.core.lib.item.ItemBlockSlab;
import epicsquid.gadgetry.core.lib.model.CustomModelBlock;
...
import epicsquid.gadgetry.core.lib.model.block.BakedModelCube;
import epicsquid.gadgetry.core.lib.model.block.BakedModelSlab;
...
public class BlockSlabBase extends BlockSlab implements IBlock, IModeledObject, ICustomModeledObject {
  ...
  public BlockSlabBase(Material mat, SoundType type, float hardness, String name, IBlockState parent, boolean isDouble, Block slab) {
    ...
    this.slab = slab;
    if (!isDouble) {
      itemBlock = new ItemBlockSlab(this, slab).setRegistryName(ELRegistry.getActiveModid(), name);
    }
  }
